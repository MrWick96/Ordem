...
class Usuarios extends CI_Controller {
    ...
    public function index() {
        ...
        if (!$this->ion_auth->is_admin()) {
            $this->session->set_flashdata('info', 'Você não tem permissão para ecessar o menu Usuários');
            redirect('/');
        }
    ...
    public function add() {
        ...
        $this->form_validation->set_rules('password', 'Senha', 'required|min_length[8] |max_length[255]');
    ...
    public function edit($usuario_id = NULL) {
        ...
        //se nao for adm e tentar editar user diferente do seu
        if (!$this->ion_auth->is_admin()) {
        ...
        if (!$usuario_id || !$this->ion_auth->user($usuario_id)->row()) {
            ...
            $this->form_validation->set_rules('password', 'Senha', 'min_length[8] |max_length[255]');
            $this->form_validation->set_rules('confirm_password', 'Confirme', 'matches[password]');
...
//                exit();
    ...
    public function del($usuario_id = NULL) {
        ...
        if ($this->ion_auth->delete_user($usuario_id)) {
            ...
            $this->session->set_flashdata('error', 'O usuário não pode ser exlcuído!');
            redirect('usuarios');
        }
    }
