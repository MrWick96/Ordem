...
//        exit();
    ...
    public function edit($fornecedor_id = NULL) {
        ...
        if (!$fornecedor_id || !$this->core_model->get_by_id('fornecedores', array('fornecedor_id' => $fornecedor_id))) {
            ...
            $this->form_validation->set_rules('fornecedor_cnpj', '', 'trim|required|exact_length[18]|callback_valida_cnpj'); //18 char
            ...
            if ($this->form_validation->run()) {
                ...
                if ($this->db->table_exists('produtos')) {
                    ...
                    if ($fornecedor_ativo == 0 && $this->core_model->get_by_id('produtos', array('produto_fornecedor_id' => $fornecedor_id, 'produto_ativo' => 1))) {
                        $this->session->set_flashdata('error', 'Estes fornecedor não pode ser desativado, pois está sendo utilizado em Produtos');
                        redirect('fornecedores');
                    }
                }
...
//            exit();
                ...
                /*
                 * [fornecedor_id] => 1
                  [fornecedor_data_cadastro] => 2021-01-15 17:30:08
                  [fornecedor_razao] => Leonardo tecnologia
                  [fornecedor_nome_fantasia] => Leonardo PPP
                  [fornecedor_cnpj] => 23.587.769/0001-53
                  [fornecedor_ie] =>
                  [fornecedor_telefone] =>
                  [fornecedor_celular] =>
                  [fornecedor_email] => leoppp@mail.com
                  ...
                  [fornecedor_ativo] => 1
                  [fornecedor_obs] =>
                  [fornecedor_data_alteracao] => 2021-01-15 17:30:08
                 */
    ...
    public function add() {
        ...
        $this->form_validation->set_rules('fornecedor_cnpj', '', 'trim|required|exact_length[18]|is_unique[fornecedores.fornecedor_cnpj]|callback_valida_cnpj'); //18 char
