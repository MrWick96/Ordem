    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a title="Voltar" href="<?php echo base_url('/'); ?>" class="btn btn-success col-md-1 float-right"><i class="fas fa-chevron-circle-left"></i>&nbsp;Voltar</a>   
            </div>
            <div class="card-body">
                ...
                <form action="" class="user" name="form_vendas" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 mb-1 mb-sm-0">
                                ...
                                <input type="date" class="form-control form-control-user-date" name="data_final" required="">
                            </div>
                    ...
                    <div class="mt-3">
                        <button class="btn btn-primary col-md-2 mr-2">Gerar relatório</button>
                    </div>
