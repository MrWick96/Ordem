        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form class="user" method="POST" name="form_edit">
                    ...
                    <button type="submit" class="btn btn-primary col-md-1" <?php echo ($conta_receber->conta_receber_status ==1 ? 'disabled' : '') ?>><?php echo ($conta_receber->conta_receber_status ==1 ? 'Conta paga' : 'Salvar') ?></button>
                </form>
