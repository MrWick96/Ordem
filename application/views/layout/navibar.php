    ...
    <ul class="navbar-nav ml-auto">
            ...
            <?php if (isset($contador_notificacoes) && $contador_notificacoes > 0): ?>
                ...
                <li class="nav-item dropdown no-arrow mx-1">
                    ...
                    <?php endif; ?>
                        ...
                        <a title="Gerenciar pagar vencem hoje" class="dropdown-item d-flex align-items-center" href="<?php echo base_url('pagar'); ?>">
                            <div class="mr-3">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <span><i class="fas fa-user-astronaut text-primary fa-3x"></i></span>
            </a>
