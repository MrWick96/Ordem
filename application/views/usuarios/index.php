    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a title="Cadastrar novo usuário" href="<?php echo base_url('usuarios/add') ?>" class="btn btn-success col-md-1 float-right"><i class="fas fa-user-plus"></i>&nbsp;Novo</a>   
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            <?php foreach ($usuarios as $user): ?>
                                <tr>
                                    ...
                                    <td class="text-center pr-4"><?php echo ($user->active == 1 ? '<span class="badge bg-info text-white btn-sm">Sim</span>' : '<span class="badge bg-warning text-white btn-sm">Não</span>') ?> </td>
                                    <td class="text-right">
                                        ...
                                        <a title="Excluir" href="javascript (void)" data-toggle="modal" data-target="#user-<?php echo $user->id; ?>" class="btn btn-sm btn-danger" ><i class="fas fa-trash"></i>&nbsp;&nbsp;Excluir</a>
                                    </td>
                                </tr>
