    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a title="Cadastrar nova conta" href="<?php echo base_url('pagar/add') ?>" class="btn btn-success col-md-1 float-right"><i class="fas fa-plus"></i>&nbsp;&nbsp;Nova</a>   
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            <?php foreach ($contas_pagar as $conta): ?>
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a title="Editar" href="<?php echo base_url('pagar/edit/' . $conta->conta_pagar_id); ?>" class="btn btn-sm btn-primary" ><i class="fas fa-user-edit"></i>&nbsp;&nbsp;Editar</a>
