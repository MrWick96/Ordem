                        ...
                        <tbody>
                            <?php foreach ($contas_pagar as $conta): ?>
                                <tr>
                                    ...
                                    <td><?php echo formata_data_banco_com_hora($conta->conta_pagar_data_vencimento); ?> </td>                                                       
                                    ...
                                    <td class="text-right">
                                        <a title="Editar" href="<?php echo base_url('pagar/edit/' . $conta->conta_pagar_id); ?>" class="btn btn-sm btn-primary" ><i class="fas fa-user-edit"></i></a>
                                        <a title="Excluir" href="javascript (void)" data-toggle="modal" data-target="#conta-<?php echo $conta->conta_pagar_id; ?>" class="btn btn-sm btn-danger" ><i class="fas fa-user-times"></i></a>
                                    </td>
                                </tr>
