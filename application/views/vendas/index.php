    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a title="Cadastrar nova venda" href="<?php echo base_url('vendas/add') ?>" class="btn btn-success mb-1 float-right"><i class="fas fa-plus"></i>&nbsp;&nbsp;Nova</a>   
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            <?php foreach ($vendas as $venda): ?>
                                <tr>
                                    ...
                                    <td><?php echo 'R$&nbsp' . $venda->venda_valor_total ?> </td>
                                    <td class="text-right">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a class="btn btn-danger" href="<?php echo base_url('vendas/del/'. $venda->venda_id); ?>">Sim</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
