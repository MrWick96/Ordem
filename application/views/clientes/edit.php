    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a title="Cadastrar novo cliente" href="<?php echo base_url('clientes/add'); ?>" class="btn btn-success btn-sm float-right"><i class="fas fa-chevron-circle-left"></i>&nbsp;Voltar</a>   
            </div>
            <div class="card-body">
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="text" class="form-control form-control-user-date" name="cliente_sobrenome" placeholder="Sobrenome do cliente" value="<?php echo $cliente->cliente_sobrenome; ?>">
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control form-control-user"  placeholder="Endereço" name="cliente_endereco" value="<?php echo $cliente->cliente_endereco; ?>">
                                <?php echo form_error('cliente_endereco', '<div class="form-text text-danger">', '</div>'); ?>
                            </div> 

                            <div class="col-md-2">
                                <label>Número</label>
                                <input type="text" class="form-control form-control-user"  placeholder="Número" name="cliente_numero_endereco" value="<?php echo $cliente->cliente_numero_endereco; ?>">
                                <?php echo form_error('cliente_numero_endereco', '<div class="form-text text-danger">', '</div>'); ?>
                            </div>

                            <div class="col-md-4">
                                <label>Complemento</label>
                                <input type="text" class="form-control form-control-user"  placeholder="Complemento" name="cliente_complemento" value="<?php echo $cliente->cliente_complemento; ?>">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-4">
                                <label>Bairro</label>
                                <input type="text" class="form-control form-control-user"  placeholder="Bairro" name="cliente_bairro" value="<?php echo $cliente->cliente_bairro; ?>">
                                <?php echo form_error('cliente_bairro', '<div class="form-text text-danger">', '</div>'); ?>
                            </div>

                            <div class="col-md-2">
                                <label>CEP</label>
                                <input type="text" class="form-control form-control-user cep"  placeholder="CEP" name="cliente_cep" value="<?php echo $cliente->cliente_cep; ?>">
                                <?php echo form_error('cliente_cep', '<div class="form-text text-danger">', '</div>'); ?>
                            </div>  

                            <div class="col-md-5">
                                <label>Cidade</label>
                                <input type="text" class="form-control form-control-user"  placeholder="Cidade" name="cliente_cidade" value="<?php echo $cliente->cliente_cidade; ?>">
                                <?php echo form_error('cliente_cidade', '<div class="form-text text-danger">', '</div>'); ?>
                            </div>  

                            <div class="col-md-1">
                                <label>UF</label>
                                <input type="text" class="form-control form-control-user uf"  placeholder="UF" name="cliente_estado" value="<?php echo $cliente->cliente_estado; ?>">
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <textarea class="form-control form-control-user"  placeholder="Obs" name="cliente_obs"><?php echo $cliente->cliente_obs; ?></textarea>
