    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a title="Cadastrar nova forma de pagamento" href="<?php echo base_url('modulo/add') ?>" class="btn btn-success col-md-1 float-right"><i class="fas fa-plus"></i>&nbsp;&nbsp;Nova</a>   
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            <?php foreach ($formas_pagamentos as $forma): ?>
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a title="Editar" href="<?php echo base_url('modulo/edit/' . $forma->forma_pagamento_id); ?>" class="btn btn-sm btn-primary" ><i class="fas fa-user-edit"></i>&nbsp;&nbsp;Editar</a>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a class="btn btn-danger" href="<?php echo base_url('formas_pagamentos/del/'. $forma->forma_pagamento_id); ?>">Sim</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
